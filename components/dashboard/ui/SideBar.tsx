...
const SideBar = ({ bgColor, isDarkBg }: HeroProps)  => {
  return (
	<aside
  ...
  <a className="flex items-center gap-3 px-3 py-2 rounded-lg transition hover:bg-white/20 hover:text-blue-400 cursor-pointer">
